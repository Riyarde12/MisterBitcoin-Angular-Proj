...
// import makeId from '../../Util/utilService.js'
// import { makeId } from '../../Util/utilService.js'
...
export class ContactService {
  ...
  public loadContacts(): void {
    let contacts: Contact[] | any = this._contactsDb;
  ...
  public getContactById(contactId): Observable<Contact> {
  ...
  private _addContact(contact: Contact) {
    //mock the server work
    const newContact: Contact | any = new Contact(contact.name, contact.email, contact.phone);
    newContact.setId('randId')
